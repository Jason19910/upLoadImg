...
var UploadFile = function () {
    function UploadFile() {
        var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            _ref$uploadId = _ref.uploadId,
            uploadId = _ref$uploadId === undefined ? "uploadFile" : _ref$uploadId,
            _ref$compass = _ref.compass,
            compass = _ref$compass === undefined ? true : _ref$compass,
            _ref$maxWidth = _ref.maxWidth,
            maxWidth = _ref$maxWidth === undefined ? 500 : _ref$maxWidth,
